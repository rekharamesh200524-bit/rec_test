...
$config['base_url'] = $protocol . $domain . str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']);
...
$config['sess_cookie_name'] = 'ci_session_iwork';
...
//$config['theme_locations'] = $config['base_url1'];
//$config['theme_locations1'] = $config['base_url'].'themes/';

$config['default_email'] = "info@inetcsc.com";

$config['default_email_name'] = "inetcsc";

$config['site_title'] = "inet";

$config['site_powered'] = "Powered by Inetcsc";

$config['site_footer'] = "Copyright Â© 2020 inet. All Rights Reserved.";
